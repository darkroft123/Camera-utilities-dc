...
function generateMenu()
{
	...
	var modchartsOption:TextOption;
	modchartsOption = new TextOption("", "", "", function() {
		var enabled = Reflect.field(FlxG.save.data, "voiidModcharts") != false;
		Reflect.setField(FlxG.save.data, "voiidModcharts", !enabled);
		FlxG.save.flush();
		updateModchartsOptionText(modchartsOption);
	});
	modchartsOption.__text.font = "normal";
	updateModchartsOptionText(modchartsOption);
	main.add(modchartsOption);
